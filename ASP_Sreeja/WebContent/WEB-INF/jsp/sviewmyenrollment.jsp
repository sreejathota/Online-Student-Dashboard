...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-row w3-padding-64">
    <div class="w3-twothird w3-container">
     <h1 class="w3-text-teal" style="margin-left:250px">Enrolled Courses</h1>
     
      <p>${information}</p>
	<p>${confirmation}</p>
	<p>${communicated }</p>

     <table class="myTable" style="margin-top:25px;margin-left:100px"> 

	<tr ><th>Course</th><th>Faculty</th><th>Schedule</th><th>Contact</th></tr>
   <c:forEach var="enrolledCourse" items="${enrolledCourses}">   
   <tr >  
   <td>${enrolledCourse.courseName}</td>  
   <td>${enrolledCourse.facultyName}</td>  
   <td>${enrolledCourse.schedule}</td>  
   <td>
   <c:if test="${enrolledCourse.facultyName != 'TBA'}">
   <a href="/ASP_Sreeja/contactfaculty/${enrolledCourse.scheduleId}">Contact Professor</a>
   </c:if></td>
