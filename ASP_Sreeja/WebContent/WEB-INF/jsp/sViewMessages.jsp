...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-row w3-padding-64">
    <div class="w3-twothird w3-container">
     <h1 class="w3-text-teal" style="margin-left:250px">InBox</h1>
	...
	<tr ><th>Faculty Name</th><th>Message</th></tr>
   <c:forEach var="message" items="${messages}">   
   <tr onclick="window.document.location='/ASP_Sreeja/viewMessageInPage/${message.studentName}';">  
