...
<h1 class="w3-text-teal" style="margin-top:10px">View Courses</h1>
      <table class="myTable" style="margin-top:35px;margin-left:100px"> 

	<tr ><th>Course Name</th><th>Faculty name</th><th>Schedule</th></tr>
  ...
  <div class="w3-center w3-padding-64">
   ...
   <c:url value="/adminController/viewcourseinformation" var="prev">
    ...
    <c:forEach begin="1" end="${maxPages}" step="1" varStatus="i">
        <%-- <c:choose>
            ...
            <c:otherwise> --%>
                <c:url value="/adminController/viewcourseinformation" var="url">
    ...
    <c:url value="/adminController/viewcourseinformation" var="next">
        <c:param name="page" value="${page + 1}"/>
    </c:url>
  ...
  <!-- <li><a class="w3-black" href="/SpringMVC/viewemp/1">1</a></li>
