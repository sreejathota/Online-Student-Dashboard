...
<h1 class="w3-text-teal" style="margin-top:10px">Assign Course</h1>
      <form:form action="${pageContext.request.contextPath}/adminController/assignCourseSuccess" method="post" modelAttribute="assignCourse" id="assignCourse" >
				
    <span>${assign }</span> 
    <fieldset id="inputs">
      
       <table>
        <tr><td><form:select path="schedule">
					  <form:option value="NONE" label="--- Select Schedule---" />
					  <form:options items="${availableSchedule}" itemValue="schedule" itemLabel="schedule" />
				       </form:select></td>
				 <td><form:errors path="schedule" /></td></tr>
		<tr><td><form:select path="courseName">
    ...
    <fieldset id="actions">
        <input type="submit" id="submit" value="Assign Course">
