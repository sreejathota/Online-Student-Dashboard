...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-row w3-padding-64">
    ...
    <h1 class="w3-text-teal" style="margin-left:250px">Course Schedule</h1>
     <p>${nocourses}</p>

<table class="myTable" style="margin-top:35px;margin-left:100px"> 

<tr ><th>Course Name</th><th>Faculty Name</th><th>Schedule</th></tr>
   <c:forEach var="eachcourseschedule" items="${courseschedule}">   
   <tr style="border:1px solid black;">  
   <td>${eachcourseschedule.courseName}</td>  
   <td>${eachcourseschedule.facultyName}</td>  
   <td>${eachcourseschedule.schedule}</td>  
