...
<%--     <h1 class="w3-text-teal" style="margin-left:150px">Reply to ${student.studentName}</h1>
 --%>    
<form:form ACTION="/ASP_Sreeja/reply/${student.studentId}" commandName="c" METHOD="POST" style="margin-left: 250px;margin-top: 25px">
	<p>You are sending response to ${student.firstName}</p><br>
