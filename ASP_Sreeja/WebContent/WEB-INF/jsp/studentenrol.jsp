...
<nav class="w3-sidenav w3-collapse w3-theme-l5 w3-animate-left" style="z-index:3;width:250px;margin-top:51px;" id="mySidenav">
  ...
  <h4><b>Hi ${student.firstName}</b></h4>
  <a href="/ASP_Sreeja/gobackstudentenroll" class="w3-hover-black">Home</a>
   <a href="/ASP_Sreeja/emailconfirmation" class="w3-hover-black">Send Email Confirmation</a>
  <a href="/ASP_Sreeja/viewmyenrollment" class="w3-hover-black">View Enrolled Courses</a>
  <a href="/ASP_Sreeja/viewmymessages" class="w3-hover-black">View Messages</a>
...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-row w3-padding-64">
    <div class="w3-twothird w3-container">
      <h1 class="w3-text-teal" style="margin-left:250px">Summer Enrollment</h1>
...
<tr ><th>Course</th><th>Faculty</th><th>Schedule</th><th>Enroll/Drop</th>
   <c:forEach var="courseInformation" items="${filteredcourseInformations}">   
   <tr>  
   <td>${courseInformation.courseName}</td>  
   <td>${courseInformation.facultyName}</td>  
   <td>${courseInformation.schedule}</td>  
  <c:choose> 
  
  
  <c:when test="${courseInformation.enrolCheck == 'enrolled'}">
  <td><a href="/ASP_Sreeja/dropcourse/${courseInformation.scheduleId}">Drop</a></td>
 
  </c:when>
  
  <c:otherwise>
      <td><a href="/ASP_Sreeja/enrolcourse/${courseInformation.scheduleId}">Enroll</a></td>
  </c:otherwise>
</c:choose> 
  ...
  <footer id="myFooter" style="margin-top:58px">
