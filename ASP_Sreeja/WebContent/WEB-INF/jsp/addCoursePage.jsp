...
<h1 class="w3-text-teal" style="margin-top:10px">Add Course</h1>
      <form:form action="${pageContext.request.contextPath}/adminController/addCourseSuccess" method="post" modelAttribute="course" id="addCourse" >
				
   <span>${course }</span> 
    <fieldset id="inputs">
      
       <table>
        <tr><td><form:input path="courseName" id="courseName" placeholder="Course Name" autofocus="autofocus" required="required"/></td>     
        <td><form:input path="seats" id="seats" placeholder="No of Seats" required="required"/></td></tr>
        <tr><td><form:errors path="courseName" /> </td>
        <td><form:errors path="seats" /></td></tr>
       <%--  <tr><td><form:errors path="courseName" /> </td>
        <td><form:errors path="seats" /></td></tr>
       <tr> <td><form:select path="facultyName">
					  <form:option value="NONE" label="--- Select ---" />
					  <form:options items="${facultyNames}" />
				       </form:select>
                                </td>
