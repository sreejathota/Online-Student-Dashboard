...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-row w3-padding-64">
    <div class="w3-twothird w3-container">
      <h1 class="w3-text-teal" style="margin-left:250px">Contact Faculty</h1>
     <form:form ACTION="/ASP_Sreeja/sendmessage/${scheduleId}" commandName="c" METHOD="POST" style="margin-left: 250px;margin-top: 25px">
	<p>You are sending message to ${faculty}</p><br><br>
  	Type Message<br><form:textarea path="message" rows="5" cols="80"></form:textarea>
  ...
  <footer id="myFooter" style="margin-top:25px">
