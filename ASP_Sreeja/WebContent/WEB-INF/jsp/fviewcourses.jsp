...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-row w3-padding-64">
    ...
    <h1 class="w3-text-teal" style="margin-left:120px">Click on each course to view students</h1>
    
<table class="myTable" style="margin-top:35px;margin-left:100px"> 

   <c:forEach var="courses" items="${scheduleIds}">    
   <tr>  
   <td><a href="/ASP_Sreeja/viewenrolledstudent/${courses.scheduleId}">${courses.courseName}</a></td>  
